...
* Определение требований к модели  
 ...
 Формальное определение цели моделирования (вопросы к модели): спроектировать процессы связанные с процессом визуализации данных в курсе лабораторных работ  
